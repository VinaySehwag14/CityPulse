...
import { Heart, Users, Calendar, MapPin, MessageCircle } from 'lucide-react';
    ...
    return (
        <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
            ...
            <div className="space-y-3">
                ...
                {event.description && <p className="text-[#8b949e] text-base leading-relaxed">{event.description}</p>}
            </div>
            ...
            <div className="glass rounded-2xl p-4 space-y-3">
                <div className="flex items-center gap-3 text-sm text-[#8b949e]">
                    ...
                    <div>
                        ...
                        <p className="text-xs">Ends: {formatDate(event.end_time)}</p>
                    </div>
                </div>
                <div className="flex items-center gap-3 text-sm text-[#8b949e]">
            ...
            {event.attendees.length > 0 && (
                <div className="glass rounded-2xl p-4">
                    <h2 className="text-sm font-semibold text-[#e6edf3] mb-3 flex items-center gap-2">
                        <Users className="w-4 h-4 text-[#0caee8]" /> Attendees ({event.attendee_count})
                    </h2>
            ...
            <div className="glass rounded-2xl p-4">
                <h2 className="text-sm font-semibold text-[#e6edf3] mb-4 flex items-center gap-2">
                    <MessageCircle className="w-4 h-4 text-[#0caee8]" /> Comments ({event.comments.length})
                </h2>
