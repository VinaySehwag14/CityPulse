...
export default function SignUpPage() {
    return (
        <div className="min-h-screen relative flex items-center justify-center px-4 overflow-hidden bg-[#0d1117]">
            ...
            <div className="absolute top-1/3 left-1/4 w-[400px] h-[400px] bg-blue-500/10 rounded-full blur-[80px] pointer-events-none" />
                ...
                <SignUp
                    appearance={{
                        ...
                        elements: {
                            ...
                            socialButtonsBlockButton: 'bg-[#1c2128] border border-[#30363d] hover:bg-[#252b33] rounded-xl transition-all duration-200 shadow-sm',
                            ...
                            identityPreviewEditButton: 'text-[#0caee8] hover:text-[#7cd8fc]',
                        },
                    }}
                />
            </div>
